...
public class Problem54 {
    ...
    public int eulerProblem54() {
        int count = 0;
        for(int i = 0; i < handsArr.length; ++i) {
            Hand h1 = new Hand(handsArr[i][0], handsArr[i][1], handsArr[i][2], handsArr[i][3], handsArr[i][4]);
            Hand h2 = new Hand(handsArr[i][5], handsArr[i][6], handsArr[i][7], handsArr[i][8], handsArr[i][9]);
    ...
    public class Hand implements Comparable {
        ...
        public Hand(String c1, String c2, String c3, String c4, String c5) {
            ...
            for(int i = 0; i < 5; ++i) {
                if(hand[i].suit == hand[i].HEART) {
                    ++hearts;
                } else if(hand[i].suit == hand[i].SPADE) {
                    ++spades;
                } else if(hand[i].suit == hand[i].DIAMOND) {
                    ++diamonds;
                } else {
                    ++clubs;
                }
        ...
        public int compareTo(Object h) {
            ...
            if(this.isStraightFlush()) {
                if(this.hand[4].val > o.hand[4].val) {
                    return 1;
                } else if(this.hand[4].val < o.hand[4].val) {
                    return -1;
                } else {
                    return 0;
                }
            ...
            if(this.isFourOfAKind()) {
                if(this.hand[2].val > o.hand[2].val) {
                    return 1;
                } else if(this.hand[2].val < o.hand[2].val) {
                    return -1;
                } else {
                    return 0;
                }
            ...
            if(this.isFullHouse()) {
                if(this.hand[2].val > o.hand[2].val) {
                    ...
                    if(this.hand[2].val == this.hand[0].val) { //top three at the bottom
                        if(o.hand[2].val == o.hand[0].val) { //o's top three at the bottom
                            if(this.hand[4].val > o.hand[4].val) {
                                return 1;
                            } else if(this.hand[4].val < o.hand[4].val) {
                                return -1;
                        ...
                        } else { //o's top three at the top
                            return -1;
                        }
                    } else { //top three at the top
                        if(o.hand[2].val == o.hand[4].val) { //o's top three at the top
                            if(this.hand[0].val > o.hand[0].val) {
                                return 1;
                            } else if(this.hand[0].val < o.hand[0].val) {
                                return -1;
                            } else {
                                return 0;
                            }
            ...
            if(this.isFlush()) {
                ...
                if(this.hand[3].val > o.hand[3].val) {
                    return 1;
                } else if(this.hand[3].val < o.hand[3].val) {
                    return -1;
                }
                ...
                if(this.hand[1].val > o.hand[1].val) {
                    return 1;
                } else if(this.hand[1].val < o.hand[1].val) {
                    return -1;
                }
            ...
            if(this.isThreeOfAKind()) {
                if(this.hand[2].val > o.hand[2].val) {
                    ...
                    if(this.hand[2].val == this.hand[0].val) { //three at the bottom
                        if(o.hand[2].val == o.hand[0].val) {//o's three at bottom
                            if(this.hand[4].val > o.hand[4].val) {
                                return 1;
                            } else if(this.hand[4].val < o.hand[4].val) {
                                return -1;
                        ...
                        } else { //o's three at top
                            return -1;
                        }
                    } else { //three at top
                        if(o.hand[2].val == o.hand[4].val) { //o's three at top
                            if(this.hand[1].val > o.hand[1].val) {
                                return 1;
                            } else if(this.hand[1].val < o.hand[1].val) {
                                return -1;
            ...
            if(this.isTwoPairs()) {
                ...
                && this.hand[2].val == this.hand[3].val) {
                    ...
                    h1[1] = this.hand[2];
                    h1[2] = this.hand[4];
                } else if(this.hand[1].val == this.hand[2].val
                && this.hand[3].val == this.hand[4].val) {
                    h1[0] = this.hand[1];
                    h1[1] = this.hand[3];
                    h1[2] = this.hand[0];
                } else if(this.hand[0].val == this.hand[1].val
                && this.hand[3].val == this.hand[4].val) {
                    h1[0] = this.hand[0];
                    h1[1] = this.hand[3];
                    h1[2] = this.hand[2];
                ...
                if(o.hand[0].val == o.hand[1].val
                && o.hand[2].val == o.hand[3].val) {
                    h2[0] = o.hand[0];
                    h2[1] = o.hand[2];
                    h2[2] = o.hand[4];
                } else if(o.hand[1].val == o.hand[2].val
                && o.hand[3].val == o.hand[4].val) {
                    h2[0] = o.hand[1];
                    h2[1] = o.hand[3];
                    h2[2] = o.hand[0];
                } else if(o.hand[0].val == o.hand[1].val
                && o.hand[3].val == o.hand[4].val) {
                    h2[0] = o.hand[0];
                    h2[1] = o.hand[3];
                    h2[2] = o.hand[2];
                ...
                if(h1[1].val > h2[1].val) {
                    return 1;
                } else if(h1[1].val < h2[1].val) {
                    return -1;
                } else {
                    if(h1[0].val > h2[0].val) {
                        return 1;
                    } else if(h1[0].val < h2[0].val) {
                        return -1;
                    } else {
                        if(h1[2].val > h2[2].val) {
                            return 1;
                        } else if(h1[2].val < h2[2].val) {
                            return -1;
                        } else {
                            return 0;
                        }
            ...
            if(this.isOnePair()) {
                ...
                if(this.hand[0].val == this.hand[1].val) {
                    ...
                    h1[3] = this.hand[1];
                    h1[4] = this.hand[2];
                } else if(this.hand[2].val == this.hand[3].val) {
                    h1[0] = this.hand[0];
                    h1[1] = this.hand[1];
                    h1[2] = this.hand[4];
                    h1[3] = this.hand[2];
                    h1[4] = this.hand[3];
                } else if(this.hand[3].val == this.hand[4].val) {
                    h1[0] = this.hand[0];
                    h1[1] = this.hand[1];
                    h1[2] = this.hand[2];
                    h1[3] = this.hand[3];
                ...
                if(o.hand[0].val == o.hand[1].val) {
                    ...
                    h2[3] = o.hand[1];
                    h2[4] = o.hand[2];
                } else if(o.hand[2].val == o.hand[3].val) {
                    h2[0] = o.hand[0];
                    h2[1] = o.hand[1];
                    h2[2] = o.hand[4];
                    h2[3] = o.hand[2];
                    h2[4] = o.hand[3];
                } else if(o.hand[3].val == o.hand[4].val) {
                    h2[0] = o.hand[0];
                    h2[1] = o.hand[1];
                    h2[2] = o.hand[2];
                    h2[3] = o.hand[3];
                ...
                if(h1[4].val > h2[4].val) {
                    return 1;
                } else if(h1[4].val < h2[4].val) {
                    return -1;
                }
        ...
        public boolean isRoyalFlush() {
            return this.isStraightFlush() && this.hand[4].val == 14;
        }
        ...
        public boolean isFourOfAKind() {
            return (this.hand[0].val == this.hand[1].val
            && this.hand[0].val == this.hand[2].val
            && this.hand[0].val == this.hand[3].val) ||
            (this.hand[1].val == this.hand[2].val
            && this.hand[1].val == this.hand[3].val
            && this.hand[1].val == this.hand[4].val);
        }
        
        public boolean isFullHouse() {
            return (this.hand[0].val == this.hand[1].val
                && this.hand[2].val == this.hand[3].val
                && this.hand[2].val == this.hand[4].val)
                || (this.hand[0].val == this.hand[1].val &&
                    this.hand[0].val == this.hand[2].val &&
                    this.hand[3].val == this.hand[4].val);
        }
        
        public boolean isFlush() {
            return this.hearts == 5
            || this.spades == 5
            || this.diamonds == 5
            || this.clubs == 5;
        }
        ...
        public boolean isStraight() {
            for(int i = 1; i < 5; ++i) {
                if(this.hand[i].val - 1 != this.hand[i-1].val) {
                    return false;
                }
            }
            return true;
        ...
        public boolean isThreeOfAKind() {
            for(int i = 2; i < 5; ++i) {
                if(this.hand[i].val == this.hand[i-1].val && this.hand[i].val == this.hand[i-2].val) {
                    return true;
                }
            }
            return false;
        ...
        public boolean isOnePair() {
            ...
            || this.hand[0].val == this.hand[2].val
            || this.hand[0].val == this.hand[3].val
            || this.hand[0].val == this.hand[4].val
            || this.hand[1].val == this.hand[2].val
            || this.hand[1].val == this.hand[3].val
            || this.hand[1].val == this.hand[4].val
            || this.hand[2].val == this.hand[3].val
        ...
        public class Card implements Comparable {
            ...
            public Card(String spec) {
                if(spec.charAt(0) == '2') {
                    this.val = 2;
                } else if(spec.charAt(0) == '3') {
                    this.val = 3;
                } else if(spec.charAt(0) == '4') {
                    this.val = 4;
                } else if(spec.charAt(0) == '5') {
                    this.val = 5;
                } else if(spec.charAt(0) == '6') {
                    this.val = 6;
                } else if(spec.charAt(0) == '7') {
                    this.val = 7;
                } else if(spec.charAt(0) == '8') {
                    this.val = 8;
                } else if(spec.charAt(0) == '9') {
                    this.val = 9;
                } else if(spec.charAt(0) == 'T') {
                    this.val = 10;
                } else if(spec.charAt(0) == 'J') {
                    this.val = 11;
                } else if(spec.charAt(0) == 'Q') {
                    this.val = 12;
                } else if(spec.charAt(0) == 'K') {
                    this.val = 13;
                } else if(spec.charAt(0) == 'A') {
                    this.val = 14;
                } else {
                    //doesn't happen
                }
                ...
                if(spec.charAt(1) == 'H') {
                    this.suit = HEART;
                } else if(spec.charAt(1) == 'S') {
                    this.suit = SPADE;
                } else if(spec.charAt(1) == 'D') {
                    this.suit = DIAMOND;
                } else if(spec.charAt(1) == 'C') {
                    this.suit = CLUB;
                } else {
                    //doesn't happen
                }
    ...
    public static void main(String args[]) {
        System.out.println((new Problem54()).eulerProblem54());
    }
    
    public String[][] handsArr = {{"8C","TS","KC","9H","4S","7D","2S","5D","3S","AC"},
