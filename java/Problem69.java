...
public class Problem69 {
    ...
    public int eulerProblem69() {
        ...
        for(int n = 2; n <= 1000000; ++n) {
            ...
            for(int i = 0; i < factors.size(); i += 2) {
                totient *= Math.pow(factors.get(i), factors.get(i+1)) - Math.pow(factors.get(i), factors.get(i+1)-1);
            }
            if(n/totient > maxQ) {
                maxQ = n/totient;
                maxN = n;
    ...
    public static void main(String args[]) {
        System.out.println((new Problem69()).eulerProblem69());
    }
